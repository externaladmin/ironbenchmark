...
export default async function handler(req, res) {
  ...
  try {
    ...
    const customFields = [
      ...
      ...(r.q6_channels          ? [{ name: 'ib_channels',            value: r.q6_channels }]          : []),
      ...(r.q7_largest_channel   ? [{ name: 'ib_largest_channel',     value: r.q7_largest_channel }]   : []),
      ...(r.q8_tradeshow_share   ? [{ name: 'ib_tradeshow_share',     value: r.q8_tradeshow_share }]   : []),
      ...(r.q9_digital_channels  ? [{ name: 'ib_digital_channels',    value: r.q9_digital_channels }]  : []),
      ...
      ...(r.q13_increase_spend   ? [{ name: 'ib_increase_spend',      value: r.q13_increase_spend }]   : []),
      ...(r.q14_performance      ? [{ name: 'ib_performance',         value: r.q14_performance }]      : []),
    ];
